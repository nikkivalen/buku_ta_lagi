...
from server.models.utils.utils import create_dico, create_mapping
from server.models.utils.utils import zero_digits,is_float
from server.models.utils.utils import iob2, iob_iobes,insert_singletons
from server.models.utils.utils import cost_matrix
...
def augment_with_pretrained(dictionary, ext_emb_path, words):
    ...
    with open(ext_emb_path, 'r', encoding='utf-8', errors='ignore') as f:
